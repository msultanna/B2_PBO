...
import Posttest4.Matras;
import Posttest4.Sintetis;
...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        ArrayList<Posttest4.Sintetis> dataSintetis = new ArrayList<>();
        ArrayList<Posttest4.Matras> dataMatras = new ArrayList<>();
        int pilihan;
        String namapenyewa;
            ...
            switch (menu) {
                case 1:
                    ...
                    if (pilihan == 1) {
                        ...
                        dataSintetis.add(new Posttest4.Sintetis(namapenyewa, nomorlapangan, jenislapangan, harga));
                    } 
                    if (pilihan == 2) {
                        System.out.println("Masukan Nama Penyewa : ");
                        namapenyewa = input.readLine();
                        ...
                        System.out.println("Masukan Harga : ");
                        Integer.parseInt(input.readLine());
                        dataMatras.add(new Posttest4.Matras(namapenyewa, nomorlapangan, jenislapangan, harga));   
                    }
