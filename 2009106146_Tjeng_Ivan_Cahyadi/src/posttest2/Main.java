...
public class Main {
    ...
    static void tampilBarang(ArrayList<Toko> kumpulanBarang){
        ...
        for (int i = 0; i < kumpulanBarang.size(); i++){
            ...
            System.out.println("%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%");
            kumpulanBarang.get(i).printData();
            System.out.println("%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%");
            System.out.println("");
        }
    }
    ...
    static void tampilBarangBelanja(ArrayList<Belanja> kumpulanBarangBelanja){
        ...
        for (int i = 0; i < kumpulanBarangBelanja.size(); i++){
            ...
            System.out.println("                      " + (i + 1) + "                      ");
            System.out.println("%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%");
            kumpulanBarangBelanja.get(i).printData();
            System.out.println("%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%");
            System.out.println("");
        }
    }
    ...
    static void tampilBadanTransaksi(ArrayList<Belanja> kumpulanBarangBelanja){
        System.out.println("%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%");
        System.out.println("No\tNama\t\t\t\t\t\tQty\tHarga\t\tPajak\t\tSubtotal");
        for (int i = 0; i < kumpulanBarangBelanja.size(); i++) {
            System.out.println((i + 1) + "\t" + kumpulanBarangBelanja.get(i).getNama() + "\t\t" + kumpulanBarangBelanja.get(i).getJumlahBarang() + "\t" + kumpulanBarangBelanja.get(i).getHarga() + "\t\t" + kumpulanBarangBelanja.get(i).pajakBarang() + "\t\tRp" + kumpulanBarangBelanja.get(i).subtotalBarangBelanja());
        }
        System.out.println("%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%");
    }
    ...
    static void transaksi(ArrayList<Belanja> kumpulanBarangBelanja){
        ...
        if (confirm.equals("y")) {
            ...
            System.out.println("");
            System.out.println("Akilektronika\t\t\t\t\t\t\t\t\t\t\tKepada Yth: " + namaPembeli);
            System.out.println("Jl. Nasi Berantas No. 666\t\t\t\t\t\t\t\t\t" + alamatPembeli);
            System.out.println("Telp. 1234567 Namek\t\t\t\t\t\t\t\t\t\t" + nomorTeleponPembeli);
            tampilBadanTransaksi(kumpulanBarangBelanja);
            System.out.println("\t\t\t\t\t\t\t\t\t\t\t\tTotal\tRp" + totalTransaksi(kumpulanBarangBelanja));
            System.out.println("\t\t\t\t\t\t\t\t\t\t\t\tDibayar\tRp" + uangPembeli);
            System.out.println("\t\t\t\t\t\t\t\t\t\t\t\tKembali\tRp" + (uangPembeli - totalTransaksi(kumpulanBarangBelanja)));
