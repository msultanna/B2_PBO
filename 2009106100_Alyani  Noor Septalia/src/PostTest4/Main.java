...
public class Main {
     static class HapusPembayaran extends Pembayaran{
         public HapusPembayaran() {
             super();
         }
    ...
    static class HapusReservasi extends Reservasi{
         public HapusReservasi() {
             super();
         }
        ...
        do {
            ...
            switch(pilih) {
                ...
                case 4:
                    ...
                    System.out.println("======================================================");
                    if(delete == 1){
                        HapusReservasi u = new HapusReservasi();
                        ...
                        HapusPembayaran h = new HapusPembayaran();
