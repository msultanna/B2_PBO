...
public final class posttest6 {
    ...
    public static void main(String args[])throws NumberFormatException, IOException {
        ...
        Dtperabotan dtperabotan = new Dtperabotan();
        Dtpakaian dtpakaian = new Dtpakaian();
        ...
        while (true) {
            ...
            switch(menu){
                case 1:
                    ...
                    if(pilih == 1){
                        System.out.println(" ");
                        Dtpakaian.brgpakaian = "Pakaian";
                        System.out.println(Dtpakaian.spesifikasi());
                        ...
                        dtpakaian.tambahpakaian();
                        
                    } else {
                        System.out.println(" ");
                        Dtperabotan.brgperabotan = "Perabotan";
                        System.out.println(Dtperabotan.spesifikasi());
