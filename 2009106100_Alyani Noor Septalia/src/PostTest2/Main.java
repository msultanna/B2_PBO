...
public class Main {
    public static void main(String[] args) {
        ...
        ArrayList<Pembayaran> p = new ArrayList<Pembayaran>();
            ...
            switch(pilih) {
                case 1:
                    ...
                    if(create == 1){
                        ...
                        r.add(new Reservasi(tanggal, jam, namaReservator, pax));
                    }else if(create == 2){
                        ...
                        p.add(new Pembayaran(kodeBooking, namaBayar, createDP, metodeBayar));
                    }
                    break;
                case 2:
                ...
                case 3:
                    ...
                    if(update == 1){
                        ...
                        System.out.print("Tanggal reservasi (DD/MM/YYYY) : ");
                        String updateTanggal = string.next();

                        System.out.print("Jam reservasi (HH.MM) : ");
                        String updateJam = string.next();

                        System.out.print("Nama pembuat reservasi : ");
                        String updateNama = string.next();

                        System.out.print("Pax : ");
                        int updatePax = angka.nextInt();

                        r.set(updateReservasi-1, new Reservasi(updateTanggal, updateJam, updateNama, updatePax));
                    }else if(update == 2) {
                        ...
                        System.out.print("Kode booking (DD/MM/YY+Pax) : ");
                        int updatekodeBooking = angka.nextInt();

                        System.out.print("Nama : ");
                        String updatenamaBayar = string.next();

                        System.out.print("DP yang dibayarkan : ");
                        int updateDP = angka.nextInt();

                        System.out.print("Metode Pembayaran : ");
                        String updatemetodeBayar = string.next();

                        p.set(updateBayar-1, new Pembayaran(updatekodeBooking, updatenamaBayar, updateDP, updatemetodeBayar));
                    }
                    break;
                case 4:
