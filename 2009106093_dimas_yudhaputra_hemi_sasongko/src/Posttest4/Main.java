...
public class Main {
    ...
    public static void menucha() throws IOException{
        InputStreamReader menu = new InputStreamReader(System.in);
        BufferedReader input = new BufferedReader(menu);
        System.out.println("");
        System.out.println("                   =----------=                     ");
...
public static void additem2() throws IOException{
        ...
        Chest itempick = new Chest(NamaItemche, rarityItem, levelItem, amountItem);
        chest.add(itempick);
        itempick.itempick();
}
...
public static String limit(String size){
    return "Thank you" + size;
        }
    }